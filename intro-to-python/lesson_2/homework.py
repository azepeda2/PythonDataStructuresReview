...
discounted_percentage = discounted_price / 100
final_price = 80 - discounted_price
print(final_price)
...
chocolate_chips = 17
cookies = 5
chip_per_cookies = chocolate_chips // cookies
remaining_chips = chocolate_chips % cookies
print(chip_per_cookies)
...
total_earnings = (first_event_participants + second_event_participants) * tickets

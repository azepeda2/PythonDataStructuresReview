...
print("Name: {} {}".format(firstName.title(), lastName.title()))
...
data = "lucy smith:28"
print("Name: {} {}".format(data[:4].title(), data[5:10].title()))
print("Age: {}".format(data[11:]))
...
cardio = int(input("Enter minutes doing cardio: "))
strength = int(input("Enter minutes doing strength: "))
training = int(input("Enter minutes doing training: "))
total = cardio + strength + training
print(f"Good Job! You spent a total of {total} minutes spent working out! Keep up the good work!")
...
# Output the result
# (ADD YOUR CODE BELOW)
reversed = str(input_number)[0] + str(input_number)[4:0:-1]
print(reversed)
